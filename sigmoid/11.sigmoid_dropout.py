...
class MLP:
    ...
    def update(self, mini_batch, learn_rate):
        ...
        self.weights_drop = [w - (learn_rate / len(mini_batch)) * bw for w, bw in zip(self.weights_drop, batch_w)]
        self.biases_drop = [b - (learn_rate / len(mini_batch)) * bb for b, bb in zip(self.biases_drop, batch_b)]
    ...
    def stochastic(self, train_data, epochs, mini_batch_size, learning_rate, valid_data, test_data):
        ...
        self.save("sigmoid_CE_softmax_dropout.json", accuracy)
